  ...
  <div class="wrap">
    <div class="header clearfloat">
      <div class="header-top">
          <textarea class="input-reset" v-model="newData.content"></textarea>
      </div>
      <div class="div-button " @click="addData">添加</div>
    </div>
        ...
        <div class="item-content">{{item.content}}</div>
          <div class="item-right">
              <div class="item-d">
                  ...
                  <img v-if="item.finish" src="../assets/img/yes-a.png" class="content-done"  alt="" @click="todoDone(item)">
                  <img v-else src="../assets/img/yes.png" class="content-done"  alt="" @click="todoDone(item)">
